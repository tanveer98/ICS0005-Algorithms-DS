...
public class Tnode {
   ...
   /*
   * if it has a child, it is followed by '('
   * if it has a sibiling, it is followed by ',' name ')'
   */
   ...
   public static Tnode buildFromRPN (String pol) {
      /*
      * In essence converts Postfix (RPN) to a prefix (LISP style) expression,using trees.
      * Algorithm:
      * If char is operand, Create TNode.name = operand, add it to stack
      * If char is operator, b = pop(), a = pop(), create TNode.name = operator, set child a, child.sibilng = b
      */
      Tnode root = null;
      // TODO!!!
